...
!     
     ...
     &     alcon,nalcon,ithermal,vold,t1,nmethod,emagn,prlab,nprint,
     &     ttime,time)
!     
...
!     
     ...
     &     imat,nmethod,ii,nprint
!     
      real*8 co(3,*),xl(3,20),xi,et,ze,xsj,shp(4,20),weight,xload(2,*),
     &     sti(6,mi(1),*),alpha(6),elcon(0:ncmat_,ntmat_,*),volume,
