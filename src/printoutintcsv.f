...
!
      subroutine printoutintcsv(prlab,ipkon,lakon,stx,eei,xstate,ener,
     &  mi,nstate_,ii,nelem,qfx,orab,ielorien,norien,co,konf,
     &  ielmat,thicke,eme,ielprop,prop,nelel,ithermal,orname,s_unit,
     &  e_unit,pe_unit,ener_unit,svd_unit,me_unit,coor_unit)
!
...
!
     ...
     &  null,ielprop(*),nelel,ithermal(*),s_unit,e_unit,pe_unit,
     &  ener_unit,svd_unit,me_unit,coor_unit
!
...
!
     ...
     &                       nelem,j,(stx(k,j,nelel),k=1,6)
               ...
               do k=1,3
                  ...
                  enddo
               enddo
               write(s_unit,'(i0,",",i0,6(",",e13.6),",",a20)')
     &              nelem,j,b(1,1),b(2,2),b(3,3),b(1,2),b(1,3),b(2,3),
     &              orname(iorien)(1:20)
            endif
         enddo
...
!
     ...
     &                       nelem,j,(eei(k,j,nelel),k=1,6)
               ...
               do k=1,3
                  ...
                  enddo
               enddo
               write(e_unit,'(i0,",",i0,6(",",e13.6),",",a20)')
     &              nelem,j,b(1,1),b(2,2),b(3,3),b(1,2),b(1,3),b(2,3),
     &              orname(iorien)(1:20)
            endif
         enddo
...
!
     ...
     &               nelem,j,(eme(k,j,nelel),k=1,6)
               ...
               do k=1,3
                  ...
                  enddo
               enddo
               write(me_unit,'(i0,",",i0,6(",",e13.6),",",a20)')
     &              nelem,j,b(1,1),b(2,2),b(3,3),b(1,2),b(1,3),b(2,3),
     &              orname(iorien)(1:20)
            endif
         enddo
...
!
            ...
            write(svd_unit,'(i0,",",i0,99(",",e13.6))')
     &            nelem,j,(xstate(k,j,nelel),k=1,nstate_)
         enddo
      elseif(prlab(ii)(1:4).eq.'COOR') then
         do j=1,mint3d
            write(coor_unit,'(i0,",",i3,3(",",e13.6))') nelem,j,
     &           (coords(k,j),k=1,3)
         enddo
      endif
!
