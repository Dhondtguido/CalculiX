...
!     
      subroutine resultsprintcsv(co,nk,kon,ipkon,lakon,ne,v,stn,inum,
...
!     
!     - stores the results in multiple .csv files, if requested
...
!
        call printoutcsv(set,nset,istartset,iendset,ialset,nprint,
