...
void contactmortar(ITG *ncont,ITG *ntie,char *tieset,ITG *nset,char *set,
		   ...
		   double *pslavdual,ITG *islavactdof,ITG *islavactdoftie,
...
void multimortar(double **aup,double *ad,ITG **irowp,ITG *jq,ITG *nzs,
		 ...
		 ITG *imastmpc,ITG *nmmpc,
		 char *tieset,
		 ITG *islavactdoftie,ITG *nelcon,double  *elcon,double *tietol,
		 ITG *ncmat_,ITG *ntmat_,
...
void premortar(ITG *iflagact,ITG *ismallsliding,ITG *nzs,ITG *nzsc2,
	       ...
	       ITG **islavmpcp,ITG **nmastspcp,ITG **imastspcp,ITG **nmastmpcp,
	       ITG **imastmpcp,ITG *nsspc,ITG *nsmpc,
...
void trafontmortar2(ITG *neq,ITG *nzs,ITG *islavactdof,ITG *islavact,
		    ...
		    double *cstressini,
		    double *bp_old,ITG *nactdof,ITG *islavnode,ITG *imastnode,
