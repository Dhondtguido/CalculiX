...
!
!
!     Generate local transformation matrix needed for quad-lin mortar method
...
!
      subroutine create_tinv_lin(ipkon,kon,lakon,islavsurf,
...
!     
     ...
     &     icounter,krow(*),kcol(*),j,nope,lface,
