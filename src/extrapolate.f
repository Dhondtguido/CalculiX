...
!     along with this program; if notd0,write to the Free Software
...
!
     ...
     &  py5(5,5),py13(13,13),py13f(13,13)
!
      include "gauss.f"
!
...
!
      data py5 /
!
!  Based on Bergot shape model
!     HIGHER-ORDER FINITE ELEMENTS FOR HYBRID MESHES
!     USING NEW NODAL PYRAMIDAL ELEMENTS
!     Bedrosion shape will give same final result
     & 2.234011d0,-0.550781d0, 0.180051d0,-0.550781d0,-0.140625d0,
     &-0.550781d0, 2.234011d0,-0.550781d0, 0.180051d0,-0.140625d0,
     & 0.180051d0,-0.550781d0, 2.234011d0,-0.550781d0,-0.140625d0,
     &-0.550781d0, 0.180051d0,-0.550781d0, 2.234011d0,-0.140625d0,
     &-0.312500d0,-0.312500d0,-0.312500d0,-0.312500d0, 1.562500d0/
!
!
      data py13 /
!
!    Based on Browning/Bedrosian shape model from
!    Felippe.f90 by John Burkardt
!
     &  3.250951d0, 1.652505d0,-0.898736d0, 1.652505d0,-0.210812d0,
     & -0.444506d0, 1.009234d0, 1.009234d0,-0.444506d0, 2.344269d0,
     & -0.045693d0,-0.108637d0,-0.045693d0,
     &  1.652505d0, 3.250951d0, 1.652505d0,-0.898736d0,-0.210812d0,
     & -0.444506d0,-0.444506d0, 1.009234d0, 1.009234d0,-0.045693d0,
     &  2.344269d0,-0.045693d0,-0.108637d0,
     & -0.898736d0, 1.652505d0, 3.250951d0, 1.652505d0,-0.210812d0,
     &  1.009234d0,-0.444506d0,-0.444506d0, 1.009234d0,-0.108637d0,
     & -0.045693d0, 2.344269d0,-0.045693d0,
     &  1.652505d0,-0.898736d0, 1.652505d0, 3.250951d0,-0.210812d0,
     &  1.009234d0, 1.009234d0,-0.444506d0,-0.444506d0,-0.045693d0,
     & -0.108637d0,-0.045693d0, 2.344269d0,
     & -4.747744d0, 1.431839d0, 1.431839d0,-4.747744d0,-0.281095d0,
     & -1.987315d0,-0.376381d0,-1.987315d0, 2.545063d0,-0.888842d0,
     &  0.252020d0, 0.252020d0,-0.888842d0,
     &  1.431839d0,-4.747744d0,-4.747744d0, 1.431839d0,-0.281095d0,
     & -1.987315d0, 2.545063d0,-1.987315d0,-0.376381d0, 0.252020d0,
     & -0.888842d0,-0.888842d0, 0.252020d0,
     & -4.747744d0,-4.747744d0, 1.431839d0, 1.431839d0,-0.281095d0,
     &  2.545063d0,-1.987315d0,-0.376381d0,-1.987315d0,-0.888842d0,
     & -0.888842d0, 0.252020d0, 0.252020d0,
     &  1.431839d0, 1.431839d0,-4.747744d0,-4.747744d0,-0.281095d0,
     & -0.376381d0,-1.987315d0, 2.545063d0,-1.987315d0, 0.252020d0,
     &  0.252020d0,-0.888842d0,-0.888842d0,
     &  3.412271d0,-0.389755d0,-0.152851d0,-0.389755d0, 0.191604d0,
     &  0.866756d0,-0.018345d0,-0.018345d0, 0.866756d0,-0.037861d0,
     &  0.115692d0,-0.067333d0, 0.115692d0,
     & -0.389755d0, 3.412271d0,-0.389755d0,-0.152851d0, 0.191604d0,
     &  0.866756d0, 0.866756d0,-0.018345d0,-0.018345d0, 0.115692d0,
     & -0.037861d0, 0.115692d0,-0.067333d0,
     & -0.152851d0,-0.389755d0, 3.412271d0,-0.389755d0, 0.191604d0,
     & -0.018345d0, 0.866756d0, 0.866756d0,-0.018345d0,-0.067333d0,
     &  0.115692d0,-0.037861d0, 0.115692d0,
     & -0.389755d0,-0.152851d0,-0.389755d0, 3.412271d0, 0.191604d0,
     & -0.018345d0,-0.018345d0, 0.866756d0, 0.866756d0, 0.115692d0,
     & -0.067333d0, 0.115692d0,-0.037861d0,
     & -0.505326d0,-0.505326d0,-0.505326d0,-0.505326d0, 2.201213d0,
     & -0.020329d0,-0.020329d0,-0.020329d0,-0.020329d0, 0.003207d0,
     &  0.003207d0, 0.003207d0, 0.003207d0/
!
      data py13f /
!
!     Based on Felippa shape model from
!     A Compendium of FEM Integration Rules for CAS Work 
!     $I.8.2 PyraGaussRuleInfo
!
     &  2.595476d0,  0.997030d0, -1.554211d0,  0.997030d0,  0.045062d0,
     & -0.590483d0,  0.863258d0,  0.863258d0, -0.590483d0,  2.322207d0,
     & -0.067755d0, -0.130699d0, -0.067755d0,
     &  0.997030d0,  2.595476d0,  0.997030d0, -1.554211d0,  0.045062d0,
     & -0.590483d0, -0.590483d0,  0.863258d0,  0.863258d0, -0.067755d0,
     &  2.322207d0, -0.067755d0, -0.130699d0,
     & -1.554211d0,  0.997030d0,  2.595476d0,  0.997030d0,  0.045062d0,
     &  0.863258d0, -0.590483d0, -0.590483d0,  0.863258d0, -0.130699d0,
     & -0.067755d0,  2.322207d0, -0.067755d0,
     &  0.997030d0, -1.554211d0,  0.997030d0,  2.595476d0,  0.045062d0,
     &  0.863258d0,  0.863258d0, -0.590483d0, -0.590483d0, -0.067755d0,
     & -0.130699d0, -0.067755d0,  2.322207d0,
     & -4.049115d0,  2.130468d0,  2.130468d0, -4.049115d0, -0.553815d0,
     & -1.831728d0, -0.220794d0, -1.831728d0,  2.700650d0, -0.865327d0,
     &  0.275535d0,  0.275535d0, -0.865327d0,
     &  2.130468d0, -4.049115d0, -4.049115d0,  2.130468d0, -0.553815d0,
     & -1.831728d0,  2.700650d0, -1.831728d0, -0.220794d0,  0.275535d0,
     & -0.865327d0, -0.865327d0,  0.275535d0,
     & -4.049115d0, -4.049115d0,  2.130468d0,  2.130468d0, -0.553815d0,
     &  2.700650d0, -1.831728d0, -0.220794d0, -1.831728d0, -0.865327d0,
     & -0.865327d0,  0.275535d0,  0.275535d0,
     &  2.130468d0,  2.130468d0, -4.049115d0, -4.049115d0, -0.553815d0,
     & -0.220794d0, -1.831728d0,  2.700650d0, -1.831728d0,  0.275535d0,
     &  0.275535d0, -0.865327d0, -0.865327d0,
     &  3.298905d0, -0.503121d0, -0.266217d0, -0.503121d0,  0.235858d0,
     &  0.841509d0, -0.043592d0, -0.043592d0,  0.841509d0, -0.041677d0,
     &  0.111876d0, -0.071148d0,  0.111876d0,
     & -0.503121d0,  3.298905d0, -0.503121d0, -0.266217d0,  0.235858d0,
     &  0.841509d0,  0.841509d0, -0.043592d0, -0.043592d0,  0.111876d0,
     & -0.041677d0,  0.111876d0, -0.071148d0,
     & -0.266217d0, -0.503121d0,  3.298905d0, -0.503121d0,  0.235858d0,
     & -0.043592d0,  0.841509d0,  0.841509d0, -0.043592d0, -0.071148d0,
     &  0.111876d0, -0.041677d0,  0.111876d0,
     & -0.503121d0, -0.266217d0, -0.503121d0,  3.298905d0,  0.235858d0,
     & -0.043592d0, -0.043592d0,  0.841509d0,  0.841509d0,  0.111876d0,
     & -0.071148d0,  0.111876d0, -0.041677d0,
     & -0.224478d0, -0.224478d0, -0.224478d0, -0.224478d0,  2.091580d0,
     &  0.042217d0,  0.042217d0,  0.042217d0,  0.042217d0,  0.012660d0,
     &  0.012660d0,  0.012660d0,  0.012660d0/
              ...
              if(lakonl(6:6).eq.'F') then
               do j=1,13
                  do k=1,nfield
                     field(k,j)=0.d0
                     do l=1,13
                        field(k,j)=field(k,j)+py13f(j,l)*yi(k,l,i)
                     enddo
                  enddo
               enddo
              else
               do j=1,13
                  do k=1,nfield
                     field(k,j)=0.d0
                     do l=1,13
                        field(k,j)=field(k,j)+py13(j,l)*yi(k,l,i)
                     enddo
                  enddo
               enddo
              endif
...
! fgr-mod 5 nodes pyramid
               do j=1,5
                  do k=1,nfield
                     field(k,j)=0.d0
                     do l=1,5
                        field(k,j)=field(k,j)+py5(j,l)*yi(k,l,i)
                     enddo
                  enddo
               enddo
            elseif(lakonl(4:4).eq.'8') then
...
!
!        C3D13 Pyramid ,, No need for determine midside node field
!         values due to 13 integrations for C3D13
!         
