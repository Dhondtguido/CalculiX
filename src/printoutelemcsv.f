...
!
      subroutine printoutelemcsv(prlab,ipkon,lakon,kon,co,
     ...
     &     xbody,nbody,else_unit,elke_unit,evol_unit,emas_unit,
     &     cent_unit)
!
...
!
     ...
     &  konl(20),iface,mortar,ielem,ielprop(*),nvol,nmas,
     ...
     &  index,nbody,else_unit,elke_unit,evol_unit,emas_unit,
     &  cent_unit
!
...
!
         ...
         write(cent_unit,'(i0,",",e13.6)') nelem,om
      endif
!
