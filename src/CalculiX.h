...
void objectivemain_se(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
             ...
             double *een,ITG *iperturb,double *f,double *fn,double *rfn,ITG *nactdof,
             ITG *iout,double *qa,
...
void results(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
             ...
             ITG *nactdof,ITG *iout,double *qa,
...
void resultsini(ITG *nk,double *v,ITG *ithermal,char *filab,
		...
		char *prlab,ITG *intpointvar,ITG *calcul_fn,ITG *calcul_f,ITG *calcul_rfn,
...
void FORTRAN(resultsini_em,(ITG *nk,double *v,ITG *ithermal,char *filab,
       ...
       ITG *calcul_fn,ITG *calcul_f,ITG *calcul_qa,ITG *calcul_cauchy,ITG *calcul_rfn,
...
void  FORTRAN(resultsprint,(double *co,ITG *nk,ITG *kon,ITG *ipkon,
       ...
       char *filab,double *een,ITG *iperturb,double *fn,double*rfn,ITG *nactdof,
