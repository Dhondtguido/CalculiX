...
!     
      subroutine calcfeasibledirection(ndesi,nodedesi,dgdxglob,nactive,
     &     nobject,nk,gradproj,gradprojname)         
!     
!     calculates the projected gradient
!     
      implicit none
!     
      character*81 gradprojname(5,*)
!     
...
!     
      ...
      dd2=0.d0
!     
!     calculation of projected gradient in case of an active constraint
!     
      gradprojname(1,1)(1:11)='PROJECTGRAD'
      do i=12,20
        gradprojname(1,1)(i:i)=' '
      enddo
!     
